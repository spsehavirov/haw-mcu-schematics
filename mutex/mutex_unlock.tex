...
\tikzset{
    ...
    queue item/.style={
        green!.9!teal, draw=teal!80, fill=teal!10, minimum width=1cm, minimum height=0.5cm,align=center
    }, 
    ...
    critical section/.style={
        black!50!green, draw=black!50!green, ultra thick, fill=green!60!gray, minimum width=3cm, minimum height=2cm
    },
    hide/.style={
        fill=none, draw=none
    },
